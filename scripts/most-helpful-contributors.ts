...
const createBody = (answers: Count[], interactions: Count[]) => {
  return [
    ...
    "",
    "The GitHub users listed in this post are recognized and celebrated for their contributions to the discussions in this GitHub organization.",
    "",
    ...
    "",
    "The following GitHub users have provided the most answers to questions. They are valued for their domain knowledge and their eagerness to help the community.",
    "",
